...
//                                        GradingVersionService gradingVersionService) {
//
//        return args -> {
...
//
//            TeachingAssistant TrietTA = teachingAssistantService.addNewTA(softwareSystem, Triet);
...
//
//            Submission submission1SSPP = submissionService.addNewSubmissionWithSubmissionDate(programmingProject, group1SS, Timestamp.valueOf("2020-1-18 23:59:59.0"));
//            Submission submission3SSDP = submissionService.addNewSubmissionWithSubmissionDate(designProject, group3SS, Timestamp.valueOf("2020-1-28 23:59:59.0"));
//            Submission submission2NSNP = submissionService.addNewSubmissionWithSubmissionDate(networkProject, group2NS, Timestamp.valueOf("2020-1-28 23:59:59.0"));
//
...
//                    Triet.getName(),
//                    criterionVersionSS_PP_B2_3.getId(),
//                    criterionSS_PP_B2_3);
//            criterionVersionService.addNewCriterionVersion(criterionVersionSS_PP_B2_3_V2);
//
//            Grading gradingCriterionVersionSS_PP_B2_3_V2 = new Grading(submission1SSPP, criterionVersionSS_PP_B2_3_V2);
//            gradingService.saveNewGrading(gradingCriterionVersionSS_PP_B2_3_V2);
//
//            GradingVersion gradingVersionCriterionVersionSS_PP_B2_3_V2 = new GradingVersion(
//                    "hahaha grading",
//                    Timestamp.valueOf("2020-3-19 19:17:59.0"),
//                    Triet.getName(),
//                    0L,
//                    gradingCriterionVersionSS_PP_B2_3_V2,
//                    10.0,
//                    "This is good"
//            );
//            gradingVersionService.addNewGradingVersion(gradingVersionCriterionVersionSS_PP_B2_3_V2);
//            submissionService.assignGrader(submission1SSPP, TrietTA);
//
//        };
//    }
