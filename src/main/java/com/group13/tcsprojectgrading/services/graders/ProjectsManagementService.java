...
//        //sync submissions <-> canvas submissions
//
//        List<GradingParticipation> graders = graderService.getGraderFromProject(project);
...
//            graderMap.put(grader.getId().getUser(), tasksArray);
...
//        }
//
//        List<GradingParticipation> gradersDatabase = graderService.getGraderFromProject(project);
//        List<String> editedActiveGraders = new ArrayList<>();
//        Map<String, GradingParticipation> availableGrader = new HashMap<>();
//        for (Iterator<JsonNode> it = gradersArrayFromCanvas.elements(); it.hasNext(); ) {
//            JsonNode node = it.next();
//            availableGrader.put(node.get("id").asText(), new GradingParticipation(
//                    project,
//                    node.get("id").asText(),
...
//        }
//        for (GradingParticipation grader: gradersDatabase) {
...
//            graderService.addNewGradingParticipation(availableGrader.get(activeGraderId));
//        }
//
...
//        GradingParticipation grader = graderService.getGraderFromGraderId(toUserId, project);
...
//
//        Map<String, ArrayNode> graderMap = new HashMap<>();
//        for (GradingParticipation grader1: graders) {
//            ObjectNode formatNode = objectMapper.createObjectNode();
//            ArrayNode tasksArray = objectMapper.createArrayNode();
